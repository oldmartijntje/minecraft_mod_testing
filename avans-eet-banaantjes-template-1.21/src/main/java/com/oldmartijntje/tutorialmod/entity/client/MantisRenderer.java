...
import com.oldmartijntje.tutorialmod.entity.custom.MantisVariant;
    ...
    private static final Map<MantisVariant, Identifier> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(MantisVariant.class), map -> {
                map.put(MantisVariant.DEFAULT,
                        Identifier.of(AvansEetBanaantjes.MOD_ID, "textures/entity/mantis/mantis.png"));
                map.put(MantisVariant.ORCHID,
                        Identifier.of(AvansEetBanaantjes.MOD_ID, "textures/entity/mantis/mantis_orchid.png"));
            });

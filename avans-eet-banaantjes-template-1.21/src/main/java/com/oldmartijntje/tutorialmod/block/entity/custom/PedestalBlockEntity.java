package com.oldmartijntje.tutorialmod.block.entity.custom;

import com.oldmartijntje.tutorialmod.block.entity.ImplementedInventory;
...
public class PedestalBlockEntity extends BlockEntity implements ImplementedInventory, ExtendedScreenHandlerFactory<BlockPos> {
    ...
    public Text getDisplayName() {
        return Text.literal("Pedestal :3");
    }

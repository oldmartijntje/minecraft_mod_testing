...
import com.oldmartijntje.tutorialmod.enchantment.custom.LimboEnchantmentEffect;
...
public class ModEnchantments {
    public static final RegistryKey<Enchantment> LIGHTNING_STRIKER =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(AvansEetBanaantjes.MOD_ID, "lightning_striker"));

    public static final RegistryKey<Enchantment> LIMBO =
            RegistryKey.of(RegistryKeys.ENCHANTMENT, Identifier.of(AvansEetBanaantjes.MOD_ID, "limbo"));
